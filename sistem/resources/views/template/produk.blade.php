...
<head>
  ...
  <link rel="{{url('public')}}/stylesheet" type="text/css" href="css/zabuto_calendar.css">
  <link rel="{{url('public')}}/stylesheet" type="text/css" href="lib/gritter/css/jquery.gritter.css" />
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="{{url('/template')}}" class="logo"><b>MELODI<span>STORE
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
            <a class="active" href="{{url('/product')}}">
          ...
          <div class="col-lg-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <div class="icn-main-container">
                  <span class="icn-container">Rp.5jt</span>
                </div>
                <p>gitar keren dengan kualitas bagus.</p>
                <a class="btn btn-theme" href="#">beli sekarang</a>
              </div>
              <!-- end custombox -->
            </div>
            <!-- end col-4 -->
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <div class="icn-main-container">
                  <span class="icn-container">Rp2jt</span>
                </div>
                <p>biola dengan suara yang unik.</p>
                <a class="btn btn-theme" href="#">beli sekarang</a>
              </div>
              <!-- end custombox -->
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                ...
                <div class="icn-main-container">
                  <span class="icn-container">Rp50jt</span>
                </div>
                <p>piano dengan kualitas terbaik sepanjang masa.</p>
                <a class="btn btn-theme" href="#">beli sekarang</a>
              </div>
              <!-- end custombox -->
            </div>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <div class="credits">
          ...
          -->
          Created with Dashio template by <a href="{{url('public')}}/https://templatemag.com/">TemplateMag</a>
        </div>
